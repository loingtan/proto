...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\x05Order\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\xb7\x02\n" +
	...
	"\x06Orders\x18\x01 \x03(\v2\f.Order.OrderR\x06Orders\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"\xba\x03\n" +
	"\x05Order\x12\x18\n" +
	...
	"\n" +
	"updated_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xca\x03\n" +
	"\fOrderService\x12D\n" +
