...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\x12\x05Order\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17validate/validate.proto\"\x9a\x02\n" +
	...
	"\bdiscount\x18\x04 \x01(\x01B\x0e\xfaB\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\bdiscount\x12f\n" +
	"\x06status\x18\x05 \x01(\tBN\xfaBKrIR\aPENDINGR\tCONFIRMEDR\n" +
	"PROCESSINGR\aSHIPPEDR\tDELIVEREDR\tCANCELLEDR\bREFUNDEDR\x06status\"O\n" +
	...
	"\x06Orders\x18\x01 \x03(\v2\f.Order.OrderR\x06Orders\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"\x9d\x03\n" +
	"\x05Order\x12\x18\n" +
	...
	"\tcoupon_id\x18\x03 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\bcouponId\x12&\n" +
