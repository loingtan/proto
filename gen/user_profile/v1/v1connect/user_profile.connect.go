...
import (
	...
	context "context"
	errors "errors"
	v1 "gitlab.zalopay.vn/loint6/go-proto/gen/user_profile/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// UserProfileServiceUpdateUserProfileProcedure is the fully-qualified name of the
	// UserProfileService's UpdateUserProfile RPC.
	UserProfileServiceUpdateUserProfileProcedure = "/user.UserProfileService/UpdateUserProfile"
...
func NewUserProfileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserProfileServiceClient {
	...
	userProfileServiceMethods := v1.File_user_profile_v1_user_profile_proto.Services().ByName("UserProfileService").Methods()
	return &userProfileServiceClient{
		...
		updateUserProfile: connect.NewClient[v1.UpdateUserProfileRequest, v1.UpdateUserProfileResponse](
			httpClient,
			baseURL+UserProfileServiceUpdateUserProfileProcedure,
			connect.WithSchema(userProfileServiceMethods.ByName("UpdateUserProfile")),
			connect.WithClientOptions(opts...),
		),
...
// UpdateUserProfile calls user.UserProfileService.UpdateUserProfile.
func (c *userProfileServiceClient) UpdateUserProfile(ctx context.Context, req *connect.Request[v1.UpdateUserProfileRequest]) (*connect.Response[v1.UpdateUserProfileResponse], error) {
...
func NewUserProfileServiceHandler(svc UserProfileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	userProfileServiceUpdateUserProfileHandler := connect.NewUnaryHandler(
		UserProfileServiceUpdateUserProfileProcedure,
	...
	return "/user.UserProfileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case UserProfileServiceUpdateUserProfileProcedure:
			userProfileServiceUpdateUserProfileHandler.ServeHTTP(w, r)
...
func (UnimplementedUserProfileServiceHandler) UpdateUserProfile(context.Context, *connect.Request[v1.UpdateUserProfileRequest]) (*connect.Response[v1.UpdateUserProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("user.UserProfileService.UpdateUserProfile is not implemented"))
}
